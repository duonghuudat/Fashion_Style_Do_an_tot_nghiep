...
// import imageProductSmall from '../../assets/images/test_small.webp'
...
//                     {convertPrice(productDetails?.price?.toLocaleString())}
//                 </WrapperPriceTextProduct>
//             </WrapperPriceProduct>

//             <WrapperAddressProduct style={{ marginBottom: '12px' }}>
//                 <span style={{ fontWeight: 500 }}>Giao đến:</span>{' '}
//                 <span style={{ color: '#1890ff' }}>{user?.address}</span>{' '}
//                 <span className="change-address" style={{ marginLeft: '8px', color: '#1890ff', cursor: 'pointer' }}>
//                     Đổi địa chỉ
//                 </span>
        ...
        <Loading isPending={isPending}>
            <Row style={{padding: '16px', background: '#fff', borderRadius: '4px'}}>
                ...
                <Row style={{ display: 'flex', gap: '24px' }}>
                    ...
                    {[productDetails?.image, productDetails?.image, productDetails?.image].map((img, idx) => (
                        <div
                        key={idx}
